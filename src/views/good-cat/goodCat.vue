<template>
	<div class="z-page">
        ...
        <!--此loading最终会被渲染在.weui-tab__panel.vux-fix-safari-overflow-scrolling所在结构内部，而weui的该样式底部设有50px内边距，所以要单独消减50px处理下-->
				<ending-tip :showLoading="true" style="margin-bottom: -50px"></ending-tip>
			</div>
		</view-box>
	</div>
</template>
